...
func create_items():
	...
	item_database.append(Item_Definition.new("mining_rig", 3, 1500, 1, "Mining rig", "Used to mine more efficiently, 3x yield.", preload("res://Textures/stone-crafting.png")))
	...
	item_database.append(Item_Definition.new("harpoon", 2, 100, 5, "Harpoon", "Can be used for whaling.", preload("res://Textures/harpoon-chain.png")))
	...
	item_database.append(Item_Definition.new("flag_england", 6, 10, 1, "Flag of England", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
	item_database.append(Item_Definition.new("flag_france", 6, 10, 1, "Flag of France", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
	item_database.append(Item_Definition.new("flag_spain", 6, 10, 1, "Flag of Spain", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
	item_database.append(Item_Definition.new("flag_netherlands", 6, 10, 1, "Flag of the Netherlands", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
	item_database.append(Item_Definition.new("flag_nordic", 6, 10, 1, "Nordic flag", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
	
	item_database.append(Item_Definition.new("flag_pirate", 6, 10, 1, "Pirate flag", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
	item_database.append(Item_Definition.new("flag_merchant", 6, 10, 1, "Merchant flag", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
	item_database.append(Item_Definition.new("flag_navy", 6, 10, 1, "Navy flag", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
	item_database.append(Item_Definition.new("flag_slaver", 6, 10, 1, "Slaver flag", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
	item_database.append(Item_Definition.new("flag_cartographer", 6, 10, 1, "Cartographer flag", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
	item_database.append(Item_Definition.new("flag_bountyhunter", 6, 10, 1, "Bountyhunter flag", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
	item_database.append(Item_Definition.new("flag_viking", 6, 10, 1, "Viking flag", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
	item_database.append(Item_Definition.new("flag_fisherman", 6, 10, 1, "Fisherman flag", "Flag used for identifying ones allegiance.", preload("res://Textures/flying-flag.png")))
